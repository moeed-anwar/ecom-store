    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-4 sm:p-6 md:p-8">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                <h1 class="text-2xl sm:text-3xl font-semibold text-gray-800">Edit Category</h1>
            </div>
            ...
            <div class="bg-white p-4 sm:p-6 rounded-xl shadow-md w-full max-w-2xl mx-auto">
                <form action="{{route('admin.categories.update', $category)}}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{$category->name}}" placeholder="Name your category"
                    ...
                    <div>
                        ...
                        <input type="text" name="description" value="{{$category->description}}" id="description" placeholder="Enter description"
                               class="w-full border border-gray-300 p-2 rounded-lg focus:ring focus:border-emerald-500">
                        @error('description')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
