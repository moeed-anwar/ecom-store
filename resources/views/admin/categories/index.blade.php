...
<div class="w-full md:hidden flex items-center justify-between px-4 py-4 bg-white shadow">
    ...
    >
        ...
        <nav class="p-4 space-y-3">
            ...
            class="block {{ request()->routeIs('admin.categories.*') ? 'text-emerald-600 font-semibold' : 'text-gray-700' }} hover:text-emerald-600">
            Categories
            </a>
        ...
        <!-- Content -->
            ...
            <div class="bg-white rounded-2xl shadow-md p-6">
                <div class="flex justify-between items-center mb-4">
                    <h1 class="sm:text-2xl sm:font-bold text-gray-800">Manage Categories</h1>
                    <a href="{{ route('admin.categories.create') }}" class="text-white font-semibold bg-emerald-600 hover:bg-emerald-700 py-2 px-4 rounded-lg transition duration-200">
                        + Add new Category
                    </a>
                </div>
